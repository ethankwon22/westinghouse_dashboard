...
1. Download updated SEDS fuel-price data
2. Regenerate the forecast workbook
3. Download updated EIA-861 reliability data
4. Replace the `.xlsx` files in the repository
5. Redeploy the app
